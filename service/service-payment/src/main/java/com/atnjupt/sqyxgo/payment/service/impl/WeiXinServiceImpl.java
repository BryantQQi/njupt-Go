...
//			paramMap.put("openid", "o1R-t5trto9c5sdYt6l1ncGmY5iY");
    ...
    /**
     * 调用微信支付接口，判断是否支付成功，并返回相关的数据
     * @param orderNo
     * @param name
     * @return
     */
    @Override
    public Map<String, String> queryPayStatus(String orderNo, String name) {
        try {
            //1、封装参数
